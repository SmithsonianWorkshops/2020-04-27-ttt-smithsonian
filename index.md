...
etherpad: https://pad.carpentries.org/2020-04-27-ttt-smithsonian            # optional: URL for the workshop Etherpad if there is one
...
This is an online event. We will meet using the online videoconference software Zoom. You will need to <a href="https://zoom.us/download">download and install their client</a> to connect with your instructors. The link to use for this event will be distributed through email.
